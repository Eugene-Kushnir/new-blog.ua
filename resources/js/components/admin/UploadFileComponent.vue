    ...
    <div class="container">
        ...
        <div class="row" v-for="(download, index) in downloads">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="Подпись для файлов" v-model="download.title">
                </div>
            </div>
            <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                <button type="button" class="btn btn-primary" @click="addFile(index)">Добавить</button>
            </div>
        </div>
    </div>
</template>
